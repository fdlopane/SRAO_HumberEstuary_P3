...
Road_Network_shapefile   = 'Road_Network_Flood.shp'
...
# The available centroids point file which we are calculating the shortest path distance from
	...
	for Dev_Site in Available_centroids:
		...
		for trgt in Target_Nodes:
			try:
				...
				dist_Inaccessible = 99999.0
				Dist_dict[Dev_Site][trgt] = dist_Inaccessible
